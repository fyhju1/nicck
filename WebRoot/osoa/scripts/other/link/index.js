 ...
 * 专户知识  --专户理财
 */
define("osoa/scripts/other/link/index", function(require, exports, module) {
    var layerUtils = require("layerUtils");
    var pageId = "#other_link_index ";
    ...
    function initArticleList(page, pageSize) {
            ...
            if (error_no == 0) {
                ...
                if (results && results[0].data.length > 0) {
                    ...
                    for (var i = 0; i < results[0].data.length; i++) {
                        ...
                        // str += '<a target="_blank" href="/osoa/views/other/link/detail/' + results[0].data[i].article_id + '.html"><span>' + results[0].data[i].publish_date + '</span><strong>' + results[0].data[i].title + '</strong></a>';
                        if (results[0].data[i].type != "0") {
                            ...
                            str += '<a target="_blank" href="/osoa/views/other/link/detail/detail.html?article_id=' + results[0].data[i].article_id + '"><span>' + results[0].data[i].publish_date + '</span><strong>' + results[0].data[i].title + '</strong></a>';
                        }
        ...
        }, { page: page, pageSize: pageSize, catalog_id: '10323' })
    }
    ...
    var other_link_index = {
        "init": init,
        "bindPageEvent": bindPageEvent,
        "destroy": destroy
    };
    // 暴露对外的接口
    module.exports = other_link_index;
});