 ...
 * 社会责任 ---公司简介
 */
define("osoa/scripts/about/duty/detail", function(require, exports, module) {
    var layerUtils = require("layerUtils");
    var pageId = "#about_duty_detail ";
    ...
    var about_duty_detail = {
        "init": init,
        "bindPageEvent": bindPageEvent,
        "destroy": destroy
    };
    // 暴露对外的接口
    module.exports = about_duty_detail;
});