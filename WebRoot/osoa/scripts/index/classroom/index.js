 ...
 * 理财课堂列表
 */
define("osoa/scripts/index/classroom/index", function(require, exports, module) {
    var pageId = "#index_classroom_index ";
    ...
    function initArticleList(page, pageSize) {
        ...
        }, { page: page, pageSize: pageSize, catalog_id: '10280' })
    }
    ...
    // 暴露对外的接口
    module.exports = index_classroom_index;
});