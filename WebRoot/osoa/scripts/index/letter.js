 ...
 * 首页 
 */
define("osoa/scripts/index/letter", function(require, exports, module) {
    var layerUtils = require("layerUtils");
    var pageId = "#index_letter ";
    ...
    function initArticleDetail() {
        ...
        }, { articleId: constants.ARTICLEID.LETTER });
    }
