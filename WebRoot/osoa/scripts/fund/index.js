 ...
 * 旗下基金
 */
define("osoa/scripts/fund/index", function(require, exports, module) {
    var layerUtils = require("layerUtils");
    var pageId = "#fund_index ";
    ...
    function init(param) {
        ...
        var fund_type = param.fund_type;
        if (!$.string.isEmpty(fund_type)) {
            $(pageId + " #hot_type a.fundClass" + fund_type).addClass("filter_all").siblings().removeClass("filter_all");
            showProductList(fund_type, "");
        }
    ...
    function bindPageEvent() {
        ...
        $(pageId + " #hot_theme a").bindEvent(function() {
            ...
            $(pageId + " .fund_list .filter_input").val("");
        ...
        $(pageId + " .all_fund .fund_list .sort_th").bindEvent(function() {
            var search = $(pageId + " .fund_list .filter_input").val();
            ...
            showProductList(fund_type, theme_code, type, sort_type, search);
        });
        ...
        //搜索
        $(pageId + " #filter_submit").bindEvent(function() {
            var search = $(pageId + " .fund_list .filter_input").val();
            var theme_code = $(pageId + " #hot_theme  a.filter_all").attr("theme_code");
            var fund_type = $(pageId + " #hot_type a.filter_all").attr("fund_type");
            $(pageId + " .all_fund .fund_list .sort_th .sort_ctrl").removeClass("up").removeClass("down").addClass("gray");
            showProductList(fund_type, theme_code, "", "", search);
        });
     ...
     *  产品list展示
     */
    function showProductList(fund_type, theme_code, sort_column, sort_type, search) {
        fundService.getFundList(function(resultVo) {
            ...
            eachHtmlSave();
        }, { fund_type: fund_type, theme_code: theme_code, sort_column: sort_column, sort_type: sort_type, search: search });
    }
