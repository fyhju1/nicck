 ...
 * 专户知识详情  --专户理财
 */
define("osoa/scripts/separate/announce/detail", function(require, exports, module) {
    var layerUtils = require("layerUtils");
    var pageId = "#separate_announce_detail ";
    ...
    var separate_announce_detail = {
        "init": init,
        "bindPageEvent": bindPageEvent,
        "destroy": destroy
    };
    // 暴露对外的接口
    module.exports = separate_announce_detail;
});