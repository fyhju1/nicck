 ...
 * 专户知识详情  --专户理财
 */
define("osoa/scripts/separate/knowledge/detail", function(require, exports, module) {
    var layerUtils = require("layerUtils");
    var pageId = "#separate_knowledge_detail ";
    ...
    var separate_knowledge_detail = {
        "init": init,
        "bindPageEvent": bindPageEvent,
        "destroy": destroy
    };
    // 暴露对外的接口
    module.exports = separate_knowledge_detail;
});