 ...
 * 投研观点详情
 */
define("osoa/scripts/index/viewpoint/detail", function(require, exports, module) {
    var pageId = "#index_viewpoint_detail ";
    ...
    // 暴露对外的接口
    module.exports = index_viewpoint_detail;
});