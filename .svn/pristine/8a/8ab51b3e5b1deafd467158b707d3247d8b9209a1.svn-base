 ...
 * 专户知识详情  --专户理财
 */
define("osoa/scripts/other/link/detail", function(require, exports, module) {
    var layerUtils = require("layerUtils");
    var pageId = "#other_link_detail ";
    ...
    var other_link_detail = {
        "init": init,
        "bindPageEvent": bindPageEvent,
        "destroy": destroy
    };
    // 暴露对外的接口
    module.exports = other_link_detail;
});