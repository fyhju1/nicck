 ...
 * 关于华商 ---公司简介
 */
define("osoa/scripts/customer/server/trade/detail", function(require, exports, module) {
    var layerUtils = require("layerUtils");
    var articleService = require("articleService");
    var pageId = "#customer_server_trade_detail ";
    ...
    var customer_server_trade_detail = {
        "init": init,
        "bindPageEvent": bindPageEvent,
        "destroy": destroy
    };
    // 暴露对外的接口
    module.exports = customer_server_trade_detail;
});