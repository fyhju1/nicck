 ...
 * 高管致辞 ---公司简介
 */
define("osoa/scripts/about/senior/detail", function(require, exports, module) {
    var layerUtils = require("layerUtils");
    var pageId = "#about_senior_detail ";
    ...
    var about_senior_detail = {
        "init": init,
        "bindPageEvent": bindPageEvent,
        "destroy": destroy
    };
    // 暴露对外的接口
    module.exports = about_senior_detail;
});