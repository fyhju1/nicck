 ...
 * 专户知识详情  --专户理财
 */
define("osoa/scripts/other/weekly/detail", function(require, exports, module) {
    var layerUtils = require("layerUtils");
    var pageId = "#other_weekly_detail ";
    ...
    var other_weekly_detail = {
        "init": init,
        "bindPageEvent": bindPageEvent,
        "destroy": destroy
    };
    // 暴露对外的接口
    module.exports = other_weekly_detail;
});